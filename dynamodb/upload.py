...
print ("ProductCatalog table contains " + str(table.item_count) + "records")
print
print '......'
print
...
print("Forum table contains " + str(table.item_count) +"records")
print
print '......'
print
...
print("Reply table contains " + str(table.item_count) + "records")
print
print '......'
print
...
with table.batch_writer() as batch:
    ...
    Item={
        ...
        'ReplyDateTime': str(date_now - timedelta(days=14)),
    ...
    Item={
        ...
        'ReplyDateTime': str(date_now - timedelta(days=21)),
    ...
    Item={
        'Id': 'Amazon DynamoDB#DynamoDB Thread 2',
        'ReplyDateTime': str(date_now - timedelta(days=7)),
    ...
    Item={
        'Id': 'Amazon DynamoDB#DynamoDB Thread 2',
        'ReplyDateTime': str(date_now - timedelta(days=1)),
